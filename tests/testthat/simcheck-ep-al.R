...
# uncertainty in rho
al_crt2(J = 120, n = 20, delta = .3, delta_sd = 0, rho = .2, rho_sd = .1)
ep_crt2(J = 120, n = 20, delta = .3, delta_sd = 0, rho = .2, rho_sd = .1)
...
al_crt2(J = 120, n = 20, delta = .3, delta_sd = .1, rho = .2, rho_sd = 0)
ep_crt2(J = 120, n = 20, delta = .3, delta_sd = .1, rho = .2, rho_sd = 0)
...
al_crt2(J = 120, n = 20, delta = .3, delta_sd = .1, rho = .2, rho_sd = 0, test = "one.sided")
ep_crt2(J = 120, n = 20, delta = .3, delta_sd = .1, rho = .2, rho_sd = 0)
...
al_crt2(J = 120, n = 20, delta = .3, delta_sd = .8, rho = .2, rho_sd = .1)
ep_crt2(J = 120, n = 20, delta = .3, delta_sd = .8, rho = .2, rho_sd = .1)

J <- 120; n <- 20
d <- .3; delta_sd <- .8; rho <- .2; rho_sd <- .1
df <- J - 2
shapes <- beta_ab(rho, rho_sd)
rho_draws <- rbeta(1e6, shapes[1], shapes[2])
delta_draws <- rnorm(1e6, d, delta_sd)
...
ep_crt2(J = 120, n = 20, delta = .3, delta_sd = .1, rho = .2, rho_sd = .2)
...
al_msrt2(J = 50, n = 30, delta = .3, delta_sd = .1, rho = .2, rho_sd = 0,
         omega = .3, omega_sd = 0)
ep_msrt2(J = 50, n = 30, delta = .3, delta_sd = .1, rho = .2, rho_sd = 0,
         omega = .3, omega_sd = 0)

J <- 50; n <- 30; P <- .5; rsq1 <- 0; rsq2 <- 0
d <- .3; delta_sd = .1; rho = .2; omega <- .3
df <- J - 1
d_draws <- rnorm(1e6, d, delta_sd)
...
# uncertainty in rho
al_msrt2(J = 20, n = 25, delta = .3, delta_sd = 0, rho = .2, rho_sd = .1,
         omega = .3, omega_sd = 0)
ep_msrt2(J = 20, n = 25, delta = .3, delta_sd = 0, rho = .2, rho_sd = .1,
         omega = .3, omega_sd = 0)
...
al_msrt2(J = 20, n = 23, delta = .3, delta_sd = 0, rho = .2, rho_sd = 0,
         omega = .3, omega_sd = .1)
ep_msrt2(J = 20, n = 23, delta = .3, delta_sd = 0, rho = .2, rho_sd = 0,
         omega = .3, omega_sd = .1)
...
al_msrt2(J = 50, n = 30, delta = .3, delta_sd = .1, rho = .2, rho_sd = .1,
         omega = .3, omega_sd = 0)
ep_msrt2(J = 50, n = 30, delta = .3, delta_sd = .1, rho = .2, rho_sd = .1,
         omega = .3, omega_sd = 0)

J <- 50; n <- 30; P <- .5; rsq1 <- 0; rsq2 <- 0
d <- .3; delta_sd = .1; rho = .2; rho_sd = .1; omega <- .3; omega_sd <- 0
df <- J - 1
d_draws <- rnorm(1e6, d, delta_sd)
rho_ab <- beta_ab(rho, rho_sd)
rho_draws <- rbeta(1e6, rho_ab[1], rho_ab[2])
...
J <- 50; n <- 30; P <- .5; rsq1 <- 0; rsq2 <- 0
d <- .3; delta_sd = .1; rho = .2; omega <- .3; omega_sd <- .1
df <- J - 1
d_draws <- rnorm(1e6, d, delta_sd)
omega_ab <- gamma_ab(omega, omega_sd)
omega_draws <- rgamma(1e6, omega_ab[1], omega_ab[2])
...
al_msrt2(J = 20, n = 50, delta = .3, delta_sd = 0, rho = .3, rho_sd = .1,
         omega = .5, omega_sd = .1)
ep_msrt2(J = 20, n = 50, delta = .3, delta_sd = 0, rho = .3, rho_sd = .1,
         omega = .5, omega_sd = .1)
...
al_msrt2(J = 20, n = 50, delta = .3, delta_sd = .1, rho = .3, rho_sd = .1,
         omega = .5, omega_sd = .1)
ep_msrt2(J = 20, n = 50, delta = .3, delta_sd = .1, rho = .3, rho_sd = .1,
         omega = .5, omega_sd = .1)

J <- 20; n <- 50; P <- .5; rsq1 <- 0; rsq2 <- 0
d <- .3; delta_sd <- .1; rho = .3; rho_sd <- .1; omega <- .5; omega_sd <- .1
df <- J - 1
d_draws <- rnorm(1e6, d, delta_sd)
rho_ab <- beta_ab(rho, rho_sd)
rho_draws <- rbeta(1e6, rho_ab[1], rho_ab[2])
